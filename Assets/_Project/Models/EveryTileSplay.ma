...
//Name: EveryTileSplay.ma
//Last modified: Sat, Apr 18, 2015 09:07:42 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.5186035117778793 7.0730761588271456 100.1 ;
...
createNode transform -n "back1";
	setAttr ".t" -type "double3" -8.7525937091043922 3.9057415294049536 -100.1 ;
	setAttr ".r" -type "double3" 0 180 0 ;
createNode camera -n "backShape2" -p "back1";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 18.765461636928251;
...
createNode polyTweak -n "polyTweak2";
	setAttr ".uopa" yes;
	setAttr -s 7 ".tk";
	setAttr ".tk[18]" -type "float3" 0 0.0024830699 0 ;
	setAttr ".tk[19]" -type "float3" 0 0.0024830699 0 ;
	setAttr ".tk[20]" -type "float3" 0 0.0024830699 0 ;
	setAttr ".tk[21]" -type "float3" 0 0.0024830699 0 ;
	setAttr ".tk[22]" -type "float3" 0 0.0024830699 0 ;
	setAttr ".tk[23]" -type "float3" 0 0.0024830699 0 ;
...
createNode polyTweak -n "polyTweak3";
	setAttr ".uopa" yes;
	setAttr -s 8 ".tk";
	setAttr ".tk[18]" -type "float3" 0 0.035093337 0 ;
	setAttr ".tk[19]" -type "float3" 0 0.035093337 0 ;
	setAttr ".tk[20]" -type "float3" 0 0.035093337 0 ;
	setAttr ".tk[21]" -type "float3" 0 0.035093337 0 ;
	setAttr ".tk[22]" -type "float3" 0 0.035093337 0 ;
	setAttr ".tk[23]" -type "float3" 0 0.035093337 0 ;
...
createNode polyTweak -n "polyTweak4";
	setAttr ".uopa" yes;
	setAttr -s 12 ".tk";
	setAttr ".tk[19]" -type "float3" 0.0074387789 0 0 ;
	setAttr ".tk[20]" -type "float3" 0.0074387789 0 0 ;
	setAttr ".tk[21]" -type "float3" 0.0074387789 0 0 ;
	setAttr ".tk[22]" -type "float3" 0.0069561601 0 0 ;
	setAttr ".tk[23]" -type "float3" 0.0069561601 0 0 ;
	setAttr ".tk[24]" -type "float3" 0.0069561601 0 0 ;
	setAttr ".tk[25]" -type "float3" 0.0069561601 0 0 ;
	setAttr ".tk[26]" -type "float3" -0.0037252903 0 0 ;
	setAttr ".tk[27]" -type "float3" -0.0037252903 0 0 ;
	setAttr ".tk[28]" -type "float3" -0.0037252903 0 0 ;
	setAttr ".tk[29]" -type "float3" -0.0037252903 0 0 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polyPlanarProj21.out" "pPlaneShape1.i";
connectAttr "polyPlanarProj18.out" "pPlaneShape2.i";
connectAttr "polyPlanarProj22.out" "pPlaneShape3.i";
connectAttr "polyPlanarProj11.out" "pPlaneShape4.i";
connectAttr "polyPlanarProj7.out" "pPlaneShape5.i";
connectAttr "polyPlanarProj16.out" "pPlaneShape6.i";
connectAttr "polyPlanarProj17.out" "pCubeShape1.i";
connectAttr "polyPlanarProj8.out" "pCubeShape2.i";
connectAttr "polyPlanarProj9.out" "pCubeShape3.i";
connectAttr "polyPlanarProj19.out" "pCubeShape4.i";
connectAttr "polyPlanarProj10.out" "pCubeShape5.i";
connectAttr "polyPlanarProj20.out" "pCubeShape6.i";
connectAttr "polyPlanarProj12.out" "pCubeShape7.i";
connectAttr "polyPlanarProj13.out" "pCubeShape8.i";
connectAttr "polyPlanarProj23.out" "pCubeShape9.i";
